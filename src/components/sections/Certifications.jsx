            ...
            >
                <div className="relative aspect-[16/11] overflow-hidden rounded-[32px] bg-slate-100 mb-6 ring-1 ring-black/5">
                    ...
                    <div className="absolute top-5 left-5">
                        <span className="rounded-full bg-white/95 backdrop-blur-md px-4 py-2 text-[9px] font-black uppercase tracking-[0.15em] text-slate-800 shadow-xl border border-white">{cert.category}</span>
                    </div>
                </div>

                <div className="px-4 pb-4">
                    <div className="flex items-center justify-between mb-3">
                        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-sky-500">{cert.issuer}</p>
                        <span className="text-[9px] font-bold text-slate-300 uppercase tracking-widest">{cert.date}</span>
                    </div>
                    <h3 className="text-xl font-black text-slate-800 leading-tight tracking-tight group-hover:text-sky-600 transition-colors line-clamp-2 min-h-[3.5rem]">{cert.title}</h3>
