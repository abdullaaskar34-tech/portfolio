...
import { Children, cloneElement, useEffect, useLayoutEffect, useMemo, useRef, useState } from 'react';
...
export default function Dock({
  ...
  return (
    <motion.div style={{ width: panelWidth }} className={`dock-outer-vertical ${className}`}>
      <motion.div
        onMouseMove={({ pageY }) => {
          isHovered.set(1);
          mouseY.set(pageY);
      ...
      >
        {items.map((item, index) => (
          <DockItem
            ...
            mouseX={mouseY} // Using mouseY for vertical effect
            spring={spring}
            distance={distance}
