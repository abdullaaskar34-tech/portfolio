...
export const leadershipExperience = [
  {
    ...
    date: "2026 – 2027",
    icon: ShieldCheck,
    logo: `${import.meta.env.BASE_URL}logos/karabuk-transparent.png`,
    scale: 1.25,
  ...
  },
  {
    ...
    date: "2025 – 2026",
    icon: GraduationCap,
    logo: `${import.meta.env.BASE_URL}logos/syrian-students-federation-transparent.png`,
    scale: 1.25,
  ...
  },
  {
    ...
    date: "2026 – 2027",
    icon: HandHelping,
    logo: `${import.meta.env.BASE_URL}logos/general-union-syrian-students-transparent.png`,
    scale: 1.15,
  ...
  },
  {
    ...
    date: "2019 – 2020",
    icon: Heart,
    logo: `${import.meta.env.BASE_URL}logos/kizilay-transparent.png`,
    scale: 1.5,
...
export const projects = [
  {
    ...
    role: "Avionics Team Responsible",
